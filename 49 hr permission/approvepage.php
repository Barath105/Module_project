...
<?php
        ...
        $sql = "SELECT * FROM hrpermission WHERE status = 'Approved'";
        ...
        <nav style="position: relative;width: 1200px">
            <div class="logo"style="position: relative;top: 2px;left:122px">
                <i class=""></i> Permission Approved</div>
            <ul>
...
<table id="data-table">
    <thead>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $status = $row['status'];
                                                ...
                                                // Display the serial number for each record
                                                echo '<tr>';
        ...
        window.addEventListener("load", function () {
            var applyBtn = document.getElementById("approvedBtn");

...
<head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="s16.css">
...
<body>
  ...
  left: 40px;
    ...
    <div class="button-group">
        ...
        <a href="../29 payslip pending/i29.php">
    ...
    <form id="leaveForm" class="form" method="POST" action="payslip.php" enctype="multipart/form-data">
                    <h4>Payslip</h4>
                <div class="column">
                <div class="input-box">
                    <label>Name</label>

...
<body>
  ...
  left: 40px;
    ...
    <form id="leaveForm" class="form" method="POST" action="od.php" enctype="multipart/form-data">
                    <h4>OD request</h4>
                <div class="column">
                <div class="input-box">
                    <label>Title</label>
            ...
            function submitForm(event) {
                ...
                // Validation
                if (!title || !empId  || !startDate || !endDate || !reason) {
                ...
                showSuccessMsg("OD application submitted successfully.");
